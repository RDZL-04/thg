...
class AllAvailableCoupon extends Controller
{
  ...
  public function __invoke(Request $request)
  {
    try {
      ...
      $this->sortingCouponByExpired();
      
      return response([
        'status' => true,
        'message' => "List all available coupon",
        'code' => 200,
        'data' => [
  ...
  private function sortingCouponByExpired()
  {
    if (!$this->allCoupons) return;

    usort($this->allCoupons, function($a, $b) {
