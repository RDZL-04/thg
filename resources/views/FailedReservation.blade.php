...
<body>
  ...
  <div class="w-100 p-3" style="background-color: #fff;">
    ...
    <p>Your Order and Payment has been confirmed with the following details:</p>
    ...
    <table class="table table-borderless" style="width:100%;" >
      <tr style="height: 20px;">
        <td>
          <img width='50' height='50' id="icon" src="{{url('/')}}/asset/icon/calendar.jpg" alt="your image" />
        </td>
        <td style="border-right: 1px solid #cdd0d4;">
          Check-in<br/>
          <color style="color:#C0AB69">{{$data['reservation']['checkin_dt']}}</color>
        </td>
        <td>
          <img width='50' height='50' id="icon" src="{{url('/')}}/asset/icon/calendar.jpg" alt="your image"  />
        </td>
        <td>
          Check-out<br/>
          <color style="color:#C0AB69">{{$data['reservation']['checkout_dt']}}</color>
        </td>
      </tr>
    </table>
    ...
    <table class="table table-borderless" style="width:100%;">
      <tr>
        ...
        <td style="border-right: 1px solid #cdd0d4;color:#C0AB69;">
          {{$data['reservation']['ttl_adult']}} 
          <color style="color:#212529">Adult</color>
        </td>
        <td style="border-right: 1px solid #cdd0d4;color:#C0AB69;">
          {{$data['reservation']['ttl_children']}} 
          <color style="color:#212529"> Children </color>
        </td>
        <td style="color:#C0AB69;">
          {{$data['reservation']['ttl_room']}} 
          <color style="color:#212529">Room</color>
        </td>
      </tr>
    </table>
    ...
    <table class="table table-borderless" style="width:100%;">
      ...
      <tr>
        <td>Total Price</td>
        <td style="text-align:right; color:#C0AB69;">Rp. {{$data['reservation']['be_amountAfterTax']}}</td>
      </tr>
    </table>
